...
//맛방 detail - 맛집 리스트
router.get('/:roomId/storeList', authMiddleware, roomController.detailRoomStoreList);

//맛방 만들기
router.post('/', authMiddleware, roomController.writeRoom);

//맛방 초대 (공유하기)
router.put('/invite/:roomId', authMiddleware, roomController.inviteRoom);

//맛방 강퇴
router.put('/kick/:roomId', authMiddleware, roomController.kickRoom);
...
//맛방 순서 변경
router.put('/:roomId/roomSet', authMiddleware, roomController.setSequenceRoom);
